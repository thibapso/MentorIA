    ...
    return (
      <div className="lanyard-wrapper">
        <div style={{ color: "white", textAlign: "center", padding: "20px" }}>
          Erro ao carregar componente 3D.
          <br />
          <button
            onClick={() => {
              setError(false);
...
function Band({ maxSpeed = 50, minSpeed = 0 }: BandProps) {
  ...
  return (
    <>
      ...
      <mesh ref={band}>
        {/* @ts-expect-error - meshLineGeometry é adicionado via extend() */}
        <meshLineGeometry />
        {/* @ts-expect-error - meshLineMaterial é adicionado via extend() */}
        <meshLineMaterial
          color="white"
          depthTest={false}
